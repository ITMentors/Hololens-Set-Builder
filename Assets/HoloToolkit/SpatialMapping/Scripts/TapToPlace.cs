...
namespace HoloToolkit.Unity.SpatialMapping
{
    ...
    public class TapToPlace : MonoBehaviour, IInputClickHandler
    {
        ...
        protected virtual void Update()
        {
			...
			Debug.Log ("Made it right before IsBeingPlaced with " + this.name + " & IsBeingPlaced == " + IsBeingPlaced);
            if (IsBeingPlaced)
            {
				Debug.Log ("Made it into IsBeingPlaced with " + this.name);
                ...
                {
					Debug.Log ("Made it into Raycast check with " + this.name);
        ...
        {
			Debug.Log ("Made it into OnInputClicked for " + this.name + " & IsBeingPlaced == " + IsBeingPlaced);
